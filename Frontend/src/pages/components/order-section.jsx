            ...
            <div className="flex flex-col items-center justify-center gap-10">
              ...
              <div className="flex flex-col gap-5 text-center select-none">
                ...
                <div className="flex flex-row gap-5">
                  ...
                  <a
                    href="https://shopee.co.id/Beras-Organik-Rejonik-(Sumberejo-Organik)-100-Alami-Sehat-1kg-i.37236857.42632798351?extraParams=%7B%22display_model_id%22%3A356243430169%2C%22model_selection_logic%22%3A3%7D"
                    target="_blank"
                  >
                    <motion.button
                      initial={{
